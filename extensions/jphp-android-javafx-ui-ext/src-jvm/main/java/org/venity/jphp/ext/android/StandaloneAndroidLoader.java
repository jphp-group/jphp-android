...
public class StandaloneAndroidLoader {
    ...
    public StandaloneAndroidLoader() {
    ...
    public StandaloneAndroidLoader(ClassLoader classLoader) {
        this();
    ...
    public void loadExtensions() {
        ...
        for (Extension extension : loader) {
            System.out.println("Register extension : " + extension.getName());
